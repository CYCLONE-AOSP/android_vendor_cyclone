...
PRODUCT_COPY_FILES += \
    ...
    vendor/cyclone/prebuilt/common/bin/50-lineage.sh:$(TARGET_COPY_OUT_SYSTEM)/addon.d/50-lineage.sh
...
# Include CycloneOS branding
include vendor/cyclone/config/branding.mk
